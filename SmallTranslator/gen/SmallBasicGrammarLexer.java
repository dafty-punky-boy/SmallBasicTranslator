...
public class SmallBasicGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "BUILDIT", "OPLOG", "TKN_LESS", "TKN_GRE", 
			"TKN_EQGRE", "TKN_EQLESS", "TKN_EQ", "TKN_DIFF", "OPSUM", "OPMULT", "TKN_Else", 
			"TKN_ElseIf", "ID", "TRUE", "FALSE", "TKN_TEXT", "TKN_NUMBER", "T", "R", 
			"U", "E", "F", "A", "L", "S", "COMMENTS", "WS"
		};
	}
